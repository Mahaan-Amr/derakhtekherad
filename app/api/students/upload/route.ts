...
export async function POST(request: Request) {
  console.log('==== STUDENT IMAGE UPLOAD API REQUEST STARTED ====');
  ...
  try {
    ...
    const filename = `student_${timestamp}_${randomString}${path.extname(file.name)}`;

    // Save in the /public/uploads/students directory for direct access
    const publicUploadDir = path.join(process.cwd(), 'public', 'uploads', 'students');
    ...
    console.log('==== STUDENT IMAGE UPLOAD API REQUEST COMPLETED ====');
  }
} 