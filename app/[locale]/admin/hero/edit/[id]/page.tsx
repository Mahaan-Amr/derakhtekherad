...
// Define the edit hero slide page component
export default function EditHeroSlidePage({
  params
}: {
  params: { locale: Locale; id: string };
}) {
  // Access locale and id
  ...
  const translations = {
    ...
    dashboard: {
      title: locale === 'de' ? 'Hero-Banner bearbeiten' : 'ویرایش بنر اصلی',
    ...
    form: {
      title: locale === 'de' ? 'Hero-Slide bearbeiten' : 'ویرایش اسلاید',
