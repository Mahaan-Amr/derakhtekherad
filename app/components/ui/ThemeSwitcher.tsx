...
export default function ThemeSwitcher({ locale }: ThemeSwitcherProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div 
          className={`absolute ${isRtl ? 'right-0' : 'left-0'} mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 dark:divide-gray-700 z-50`}
        >
          <div className="py-1">
            <p className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-white">
              {locale === 'de' ? 'Farbschema' : 'طرح رنگ'}
            </p>
