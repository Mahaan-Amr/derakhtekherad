      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="mt-6">
            <a 
              href={`/${locale}/contact`}
              className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white !text-white bg-primary hover:bg-primary-dark hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
              style={{ color: 'white' }}
            >
