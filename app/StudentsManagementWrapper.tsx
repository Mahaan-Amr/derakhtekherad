...
import StudentsManagement from '@/app/components/dashboard/admin/students/StudentsManagement';

// This is a wrapper component that ensures the JWT token is added to fetch requests
export default function StudentsManagementWrapper({
  locale,
  translations
}: {
  locale: Locale;
  ...
  return <StudentsManagement locale={locale} translations={translations} />;
} 